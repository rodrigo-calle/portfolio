const education = [
  {
    ...
    description:
      "Actualmente me encuentro cursando los últimos semestres de la carrera",
  },
  {
    id: 1,
    ...
    date: "2021-2022",
    description:
      "Accedí al Bootcamp a través de una beca brindada por un programa del estado Peruano, aprendía usar el stack MERN(MongoDB, Express, React y NodeJS). De igual modo tecnologías como, GraphQL, Cypress, React Native, entre otros ",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    date: "2015-2018",
    description:
      "Técnico titulado a nombre de la nación en Redes y Comunicaciones, cuento con módulos terminados de CCNA certificados.",
  },
];
...
export const experience = [
  {
    ...
    company: "Meltsutdio",
    description:
      "DESCRIPCIÓN \n - Participo en el desarrollo de proyectos web basados en tecnologías como; Firebase, NextJS, Typescript, React, NodeJS, GraphQL, entre otros.",
  },
  {
    id: 2,
    date: "2021-2022",
